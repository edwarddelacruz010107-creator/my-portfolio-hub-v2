...
class Profile(db.Model):
    ...
    profile_image_alt = db.Column(db.String(200), default='')
    seo_keywords      = db.Column(db.String(300), default='')
    seo_indexable     = db.Column(db.Boolean, nullable=False, default=True, server_default='1')
...
class Project(db.Model):
    ...
    before_image      = db.Column(db.String(500), default='')
    before_image_alt  = db.Column(db.String(200), default='')
    after_image       = db.Column(db.String(500), default='')
    after_image_alt   = db.Column(db.String(200), default='')
    live_url          = db.Column(db.String(500), default='')
    github_url        = db.Column(db.String(500), default='')
    prototype_url     = db.Column(db.String(500), default='')
    framework         = db.Column(db.String(120), default='')
    problem_statement = db.Column(db.Text, default='')
    solution_overview = db.Column(db.Text, default='')
    outcome_summary   = db.Column(db.Text, default='')
    client_quote      = db.Column(db.Text, default='')
    client_name       = db.Column(db.String(120), default='')
    client_role       = db.Column(db.String(160), default='')
    meta_title        = db.Column(db.String(200), default='')
    meta_description  = db.Column(db.String(300), default='')
    case_study_enabled = db.Column(db.Boolean, nullable=False, default=True, server_default='1')
