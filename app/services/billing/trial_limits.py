...
PLAN_LIMIT_SECTIONS = [
    ...
    ("Content Limits", ["max_projects", "max_skills", "max_media_uploads", "max_testimonials", "max_certificates", "max_services"]),
    ...
    ("Admin Dashboard Feature Access", [
        ...
        "custom_domain", "email_services", "custom_smtp", "resend", "mailersend",
